...
public class GoalGroup {
    ...
    public static final GoalGroup KILL_MOB = new GoalGroup(List.of(
            KILL_COLORED_SHEEP, KILL_ELDER_GUARDIAN, KILL_SNOW_GOLEM, KILL_SILVERFISH, KILL_STRAY, KILL_WITCH, KILL_ZOMBIE_VILLAGER, KILL_BAT,
    ...
    public static final GoalGroup RIDE = new GoalGroup(List.of(
            RIDE_HORSE, RIDE_MINECART, RIDE_PIG
    ), 1);
    ...
    public static final GoalGroup ADVANCEMENT = new GoalGroup(List.of(
            ...
            GET_ANY_SPYGLASS_ADVANCEMENT, GET_BULLSEYE_ADVANCEMENT,
            GET_EYE_SPY_ADVANCEMENT, GET_HOT_TOURIST_DESTINATIONS_ADVANCEMENT,
            GET_SNIPER_DUEL_ADVANCEMENT, GET_THE_CITY_AT_THE_END_OF_THE_GAME_ADVANCEMENT,
            GET_THIS_BOAT_HAS_LEGS_ADVANCEMENT, GET_WHAT_A_DEAL_ADVANCEMENT,
    ...
    public static final GoalGroup REDSTONE = new GoalGroup(List.of(
            ...
            OBTAIN_OBSERVER, CRAFTER_CRAFTING_CRAFTERS_ADVANCEMENT
    ), 3);
    ...
    public static final GoalGroup TRIAL_CHAMBERS = new GoalGroup(List.of(
            ...
            CRAFTING_A_NEW_LOOK_ADVANCEMENT, CRAFTING_A_NEW_LOOK_ADVANCEMENT, MINECRAFT_TRIALS_EDITION_ADVANCEMENT
    ), 2);
    public static final GoalGroup RAID = new GoalGroup(List.of(
            GET_BAD_OMEN_STATUS_EFFECT, KILL_ALL_RAID_MOBS
    ), 1);
    public static final GoalGroup NETHER = new GoalGroup(List.of(
            GET_THOSE_WERE_THE_DAYS_ADVANCEMENT, GET_OH_SHINY_ADVANCEMENT, RIDE_HAPPY_GHAST,
            GET_THIS_BOAT_HAS_LEGS_ADVANCEMENT, GET_A_TERRIBLE_FORTRESS_ADVANCEMENT, KILL_GHAST, KILL_ZOGLIN,
            KILL_SNOW_GOLEM_IN_NETHER, GET_NOT_QUITE_NINE_LIVES_ADVANCEMENT, RETURN_TO_SENDER_ADVANCEMENT,
            WAR_PIGS_ADVANCEMENT
    ), 3);
